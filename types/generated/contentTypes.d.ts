...
export interface ApiButtonButton extends Schema.CollectionType {
  ...
  attributes: {
    ...
    button4: Attribute.String;
    button5: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiOutcomePageOutcomePage extends Schema.CollectionType {
  collectionName: 'outcome_pages';
  info: {
    singularName: 'outcome-page';
    pluralName: 'outcome-pages';
    displayName: 'outcomePage';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    paragraph3: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::outcome-page.outcome-page',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiTeamPageTeamPage extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::outcome-page.outcome-page': ApiOutcomePageOutcomePage;
